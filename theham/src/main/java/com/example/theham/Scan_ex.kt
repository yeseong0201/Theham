...
//import java.util.*
//
//class Scan_ex : AppCompatActivity() {
...
//                startActivityForResult(Intent(Scan_ex@ this, ImageCropActivity::class.java), 1234)
//            } catch (e: Exception) {
//                e.printStackTrace()
//            }
...
//            } else
//                Toast.makeText(Scan_ex@ this, "Not OK", Toast.LENGTH_LONG).show()
//        }
//    }
//
...
//                        Toast.makeText(Scan_ex@ this, "You have to grant permissions! Grant them from app settings please.", Toast.LENGTH_LONG).show()
//                        finish()
//                    }
//                    .ask()
//        } else {
...
//            val builder = AlertDialog.Builder(this@Scan_ex)
